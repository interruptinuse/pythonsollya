...
#verbosity = 1!;
#roundingwarnings = on!;
print sollya.sin(sollya.pi * 3);
print sollya.tan(sollya.pi/2);
print sollya.sin(sollya.pi * 3)/sollya.cos(sollya.pi * 2.5);
#0/0;
#1/0;
#
#
...
#restart; 
#autosimplify = on !; 
#print(rationalapprox(sin(pi/5.99),7));
#autosimplify = off !; 
#print(rationalapprox(sin(pi/5.99),7));
#
#/*********************************************************************************/
...
#/* Non-regression test for revision 1596 */
#coeff(x+x^2/4, 1.75);
#
#
#/*********************************************************************************/
...
#/* Non-regression test for revision 1623 */
#roundingwarnings = on!;
#d = [sin(pi/6)*(1-1b-40)];
#log2(sup(d)-inf(d));
#
...
#/* Non-regression test for revision  */
#(x * 1 - 1 * x * 1)/x^1;
#d=degree((x * 1 - 1 * x * 1)/x^1);
#d;
