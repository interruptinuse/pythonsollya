...
['Interval', 'RD', 'RN', 'RU', 'RZ', 'S2', 'SollyaObject', 'SollyaOperator', 'SollyaStructureWrapper', '__Settings', '__Settings0', '__builtins__', '__displayhook', '__doc__', '__file__', '__loader__', '__name__', '__package__', '__spec__', '__test__', '_print_backtraces', '_print_error_messages', '_print_native_messages', '_x_', 'absolute', 'acos', 'acosh', 'annotatefunction', 'append', 'approx', 'asciiplot', 'asin', 'asinh', 'atan', 'atanh', 'atexit', 'autodiff', 'autoprint', 'bashevaluate', 'bashexecute', 'binary', 'binary128', 'binary16', 'binary32', 'binary64', 'binary80', 'builtins', 'canonical', 'ceil', 'chebyshevform', 'checkinfnorm', 'coeff', 'collections', 'composepolynomials', 'contextlib', 'cos', 'cosh', 'decimal', 'default', 'degree', 'denominator', 'diff', 'dirtyfindzeros', 'dirtyinfnorm', 'dirtyintegral', 'dirtysimplify', 'double', 'double_double', 'doubledouble', 'doubleextended', 'dyadic', 'erf', 'erfc', 'error', 'evaluate', 'execute', 'exp', 'expand', 'expm1', 'exponent', 'externaldata', 'externalplot', 'file', 'findzeros', 'fixed', 'floating', 'floor', 'fpminimax', 'function', 'getbacktrace', 'getsuppressedmessages', 'guessdegree', 'halfprecision', 'has_sage_support', 'head', 'hexadecimal', 'horner', 'implementconstant','implementpoly', 'inf', 'infnorm', 'inspect', 'integral', 'itertools', 'length', 'libraryconstant', 'locale', 'log', 'log10', 'log1p', 'log2', 'mantissa', 'max', 'mid', 'min', 'nearestint', 'numberroots', 'numerator', 'objectname', 'off', 'on', 'parse', 'perturb', 'pi', 'plot', 'postscript', 'postscriptfile', 'powers', 'precision', 'prepend', 'printdouble', 'printexpansion', 'printsingle', 'printxml', 'quad', 'rationalapprox', 'readxml', 'relative', 'remez', 'revert', 'round', 'roundcoefficients', 'roundcorrectly', 'searchgal', 'settings', 'simplify', 'sin', 'single', 'sinh', 'sort', 'sqrt', 'subpoly', 'substitute', 'sup', 'supnorm', 'suppressmessage', 'sys', 'tail', 'tan', 'tanh', 'taylor', 'taylorform', 'traceback', 'triple_double', 'tripledouble', 'types', 'unsuppressmessage', 'warnings', 'x']
