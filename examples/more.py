...
>>> type(exp(1)) # doctest: +ELLIPSIS
<... 'sollya.SollyaObject'>

>>> fpminimax(exp(x), 5, [binary64]*6, Interval(-1,1))
1.00002756836036632570596793812001124024391174316406 + _x_ * (0.99983695994996946154742545331828296184539794921875 + _x_ * (0.49934185445721385177009210565302055329084396362305 + _x_ * (0.16727425716485810891498431374202482402324676513672 + _x_ * (4.3646259245321651631943637994481832720339298248291e-2 + _x_ * 8.0405088923770264702772792020368797238916158676147e-3))))
