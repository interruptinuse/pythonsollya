...
sollya_h_list = [ # should match the order of declarations in sollya.h
  ...
  SOT(sollya_obj_t, "sollya_lib_gcd", (sollya_obj_t, sollya_obj_t)),
  SOT(sollya_obj_t, "sollya_lib_euclidian_div", (sollya_obj_t, sollya_obj_t)),
  SOT(sollya_obj_t, "sollya_lib_euclidian_mod", (sollya_obj_t, sollya_obj_t)),
